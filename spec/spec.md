...
Realtime RAG WebSocket 服务是一个基于 FastAPI 的实时检索增强生成（RAG）服务，通过 WebSocket 提供流式语音识别（ASR）结果处理、智能问题检测和问答功能。系统支持多种 RAG 和搜索服务提供商，提供统一的抽象接口。
