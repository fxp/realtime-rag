...
Realtime RAG 是一个基于 WebSocket 的实时检索增强生成（RAG）服务，专为语音交互场景设计。通过集成 Dify Chat API，系统能够实时处理语音识别文本，智能检测用户问题，并提供准确的智能问答服务。
